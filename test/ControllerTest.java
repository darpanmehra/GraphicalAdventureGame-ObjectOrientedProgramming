...
public class ControllerTest {
  ...
  public void testWinGame() {
    ...
    model = new GameState(6, 6, 1,
            "nonwrapping", 100, 1, rand);

    StringReader in = new StringReader("M north M north M east M east S east 1 S east 1 M east Q");
    Appendable out = new StringBuffer();
    IController controller = new Controller(in, out, model);
    controller.playGame();
  ...
  public void testLessPungentSmell() {
    ...
    StringReader in = new StringReader("M north M north M east M east M east Q");
    Appendable out = new StringBuffer();
    IController controller = new Controller(in, out, model);
    controller.playGame();
  ...
  public void testDeathByPit() {
    ...
    IController controller = new Controller(in, out, model);
    controller.playGame();
    assertTrue(out.toString().contains("You died by falling into a pit. Better luck next time.\n"));
  }
