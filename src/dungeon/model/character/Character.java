...
public interface Character {
  ...
  /**
   * This method is called when you need to shoot the arrow in the given direction with the cave
   * distance.
   *
  ...
  /**
   * If the character is killed, this method is called to get the reason of death is by falling into
   * a pit.
   *
   * @return true if the character is killed by falling into a pit, false otherwise.
   */
  boolean isDeathByPit();
}
