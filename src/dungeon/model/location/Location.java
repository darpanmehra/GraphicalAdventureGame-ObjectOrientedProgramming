...
public class Location implements ILocation {
  ...
  public Location(ILocation loc) {
    ...
    this.hasThief = loc.hasThief();
    this.hasPit = loc.hasPit();
  }
  ...
  public String printLocationInfo() {
    return String.format("(%d, %d), monster: %s, treasure: %s, neighbours: %s, has thief: %s," +
                    "has pit: %s",
            this.coordinates[0],
            this.coordinates[1], this.monster, this.treasure, this.neighbours, this.hasThief,
            this.hasPit);
  }
